...
public abstract class EntityMixin{
    ...
    @Shadow protected boolean isCollidedHorizontally;
    @Shadow protected boolean isCollidedVertically;
    @Shadow protected boolean isCollided;
    @Shadow protected boolean isInWeb;
    @Shadow protected int nextStepDistance;
    @Shadow protected int fire;
    @Shadow protected int fireResistance;
    ...
    {
        if (((Entity) (Object) this).noClip)
        {
            this.setEntityBoundingBox(((Entity) (Object) this).getEntityBoundingBox().offset(x, y, z));
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && ((Entity) (Object) this).isSneaking() && ((Entity) (Object) this) instanceof EntityPlayer;
            ...
            ((Entity) (Object) this).updateFallState(y, this.onGround, block1, blockpos);
            ...
            if (((Entity) (Object) this).canTriggerWalking() && !flag && this.ridingEntity == null)
            {
                ...
                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && block1.getMaterial() != Material.air)
                {
                    ...
                    if (((Entity) (Object) this).isInWater())
                    {
                        ...
                        ((Entity) (Object) this).playSound(((Entity) (Object) this).getSwimSound(), f, 1.0F + (((Entity) (Object) this).rand.nextFloat() - ((Entity) (Object) this).rand.nextFloat()) * 0.4F);
                    }

                    ((Entity) (Object) this).playStepSound(blockpos, block1);
                }
            }
            ...
            catch (Throwable throwable)
            {
                ...
                ((Entity) (Object) this).addEntityCrashInfo(crashreportcategory);
                throw new ReportedException(crashreport);
            }

            boolean flag2 = ((Entity) (Object) this).isWet();
            ...
            {
                ((Entity) (Object) this).playSound("random.fizz", 0.7F, 1.6F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
                this.fire = -this.fireResistance;
            }
